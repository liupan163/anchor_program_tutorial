...
impl SignedMsgUserOrders {
    ...
    pub fn validate(&self) -> XxxResult {
        validate!(
...
pub trait SignedMsgUserOrdersLoader<'a> {
    fn load(&self) -> XxxResult<SignedMsgUserOrdersZeroCopy>;
    fn load_mut(&self) -> XxxResult<SignedMsgUserOrdersZeroCopyMut>;
}

// TODO: this design, KeyPoint EntryPoint.
...
pub fn derive_signed_msg_user_pda(user_account_pubkey: &Pubkey) -> XxxResult<Pubkey> {
