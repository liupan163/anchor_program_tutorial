...
fn excute_swap<'a>(
    ...
    let swap_function = match dex {
        Dex::SplTokenSwap => todo!(),
        Dex::StableSwap => todo!(),
        Dex::Whirlpool => todo!(),
        Dex::MeteoraDynamicpool => todo!(),
        ...
        Dex::AldrinExchangeV1 => todo!(),
        Dex::AldrinExchangeV2 => todo!(),
        Dex::LifinityV1 => todo!(),
        Dex::LifinityV2 => todo!(),
        Dex::FluxBeam => todo!(),
        Dex::MeteoraDlmm => todo!(),
        Dex::RaydiumCpmmSwap => raydium::swap_cpmm,
        Dex::OpenBookV2 => todo!(),
        Dex::WhirlpoolV2 =>todo!(),
        Dex::Phoenix => todo!(),
        Dex::ObricV2 => todo!(),
        Dex::SanctumAddLiq => todo!(),
        Dex::SanctumRemoveLiq => todo!(),
        Dex::SanctumNonWsolSwap => todo!(),
        Dex::SanctumWsolSwap => todo!(),
        Dex::PumpfunBuy => todo!(),
        Dex::PumpfunSell => todo!(),
    };
    swap_function(
        remaining_accounts,
        amount_in,
